...
class SurfaceInteraction(object):
    ...
    :type normal: Unit3d
    :param index: refractive index on the image side of surface, (this should be None unless the surface type is refracting.)
...
class OpticalPlane(FlatSurface):
    ...
    def getSurfaceInteraction(self,ray):
        ...
        :type: poptitcs.ray.IntensityRay
        :return: SurfaceInteraction
...
class CircularAperture(OpticalPlane):
    ...
    def draw(self,option = None):
        ...
        plot(zvals,ytop,"k",zvals,ylower,"k",lw=2.0)
...
class AnnularAperture(CircularAperture):
    ...
    def draw(self,option = None):
        ...
        zvalb = [p.z,p.z]
        plot(zvals,ytop,"k",zvals,ylower,"k",zvalb,yblock,"k",lw=2.0)
...
class IrisAperture(CircularAperture):
    ...
    def draw(self,option = None):
        ...
        plot(zvals,ytop,"k",zvals,ylower,"k",zvalb,ytopb,"k",zvalb,ylowerb,"k",lw=2.0)
...
class ImagePlane(OpticalPlane):
    ...
    :type pt: Vector3d or float
    :param xsize: the horizontal size, (Default = 100.0)
    :type xsize: float
    :param ysize: the vertical size, defaults to xsize (square)
    :type ysize: float or None
...
class QuadricSurface(OpticalPlane):
    ...
    def draw(self,option = None):
        """
        Method to draw surface in matplotlinb plot.
        """
        p = self.getPoint()       # Reference point
        ...
        plot(zvals,yvals,"k",lw=2.0)           # Plot in black
